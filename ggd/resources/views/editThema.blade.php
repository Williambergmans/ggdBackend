        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   ...
                   <form action="{{action('themaController@update')}}" method="post"> 
                        <input type="hidden" name="id" value="<?= $row->id ?>">
            <input type="text" class="form-control" name="titleName" value="<?= $row->titel ?>"  placeholder="Titel van calamiteit"><br>
            <!--<input type="text" class="form-control wideInput"  value="<?= $row->info ?>" name="infoName" placeholder="Informatie"><br>-->
