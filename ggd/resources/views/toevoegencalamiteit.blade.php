                ...
                <div class="panel-body">
                    ...
                    <form action="" method="post"> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="textarea" class="form-control"rows="5" name="omschrijvingName" placeholder="Omschrijving">
                        </div>
                     <!--<input type="text" class="form-control" name="categorieName" placeholder="Categorie"><br>-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" rows="5" name="inhoudName" placeholder="Inhoud">
                        </div>
                        <div class="form-group">
